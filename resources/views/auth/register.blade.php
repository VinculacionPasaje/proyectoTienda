                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Identificación  <span style="font-weight:bold;color:#e65540;"> *</span></label>

                             <div class="col-md-4" style="max-width: 100%;">

                                  <div class="input-group">
                                    <span class="input-group-addon" style="border:none;"><i class="fa fa-address-card"> </i></span>
                                      <input id="id" type="text" class="form-control" name="id" value="{{ old('id') }}" placeholder="Ingrese su identificación" required  style="background-color: #f0f0f0;">
                                  </div>
                                @if ($errors->has('id'))
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Nombres <span style="font-weight:bold;color:#e65540;"> *</span></label>
                      ...
                      <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Apellidos <span style="font-weight:bold;color:#e65540;"> *</span></label>
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Dirección <span style="font-weight:bold;color:#e65540;"> *</span></label>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label" style="max-width: 100%;">Confirmar Password <span style="font-weight:bold;color:#e65540;"> *</span></label>
